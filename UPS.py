...
root = tk.Tk()
root.title("Monitor Batteria e Ventola")

voltage_label_var = tk.StringVar(value="N/A")
current_label_var = tk.StringVar(value="N/A")
power_label_var = tk.StringVar(value="N/A")
